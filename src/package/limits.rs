...
pub(crate) const MAX_XML_NODES: usize = 2_000_000;

/// Maximum content-bearing cells a repeat expansion may produce per table.
pub(crate) const MAX_EXPANSION: u64 = 4_000_000;
